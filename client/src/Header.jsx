...
<header className='flex  justify-between'>
        <Link to={'/'} href="" className='flex text-center gap-1'>
          ...
          <span className='font-bold text-xl'>Hotelio</span>
        </Link>
        ...
        <Link to={user?'/account':'/login'} className='flex items-center border gap-2 border-gray-300 rounded-full py-2 px-4 shadow-md'>
